...
public class InternationalDraughtsComputerPlayer extends APlayer{

    private ITurnManager turnManager;

    public  InternationalDraughtsComputerPlayer(IRequestor iRequestor, int player, ITurnManager turnManager){
